...
Page({
  ...
  expirepackfreepage(){
    req({
      url: util.baseUrl + "/newapi/api/pack/getexpirepackfreepage",
      method: "POST",
      data: {
  ...
  getpackorder() {
    req({
      url: util.baseUrl + "/newapi/api/pack/getpackfreepage",
      method: "POST",
      data: {
        openid: wx.getStorageSync('openid'),
        curpage: 1,
  ...
  getpackorderokpage() {
    req({
      url: util.baseUrl + "/newapi/api/pack/getpackfreeokpage",
      method: "POST",
      data: {
        openid: wx.getStorageSync('openid'),
        curpage: 1,
